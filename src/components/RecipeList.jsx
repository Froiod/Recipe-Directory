...
const RecipeList = ({recipes}) => {
  return (
    <div className='grid gap-10 max-w-[1200px] grid-cols-3 my-10 mx-auto'>
      {recipes.map((recipe) => (
        <div key={recipe.id} className='relative bg-white text-gray-700 p-5 rounded shadow-md shadow-black transition-transform ease-linear duration-300 hover:rotate-3'>
